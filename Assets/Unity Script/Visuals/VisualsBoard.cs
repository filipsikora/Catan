...
namespace Catan
{
    public class VisualsBoard : MonoBehaviour
    {
        ...
        internal void Initialize(MapBuilder builder, Material idleMat, GameState game)
        {
            _builder = builder;
        ...
        public void ResetMarkedPositions()
        {
            foreach (var vertex in Game.Map.VertexList)
            {
                ...
                var obj = GetEdgeObject(vertex.Id);
            ...
            CatanGameManager.Instance.MainUIPanel.HideLaterBuildings();
        }
        ...
        public void PlaceRobberObject()
        {
            ...
            _robberInstance = PlaceObject(CatanGameManager.Instance.CubeRobberPrefab, pos, null, null, CatanGameManager.Instance.Board);
        }
